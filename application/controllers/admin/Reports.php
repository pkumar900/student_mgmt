...
class Reports extends AUTH_Controller {
	...
	{
		$data['title']="Reports";
		$data['all_branches']=$this->Report_model->view_branch();
        $data['all_employees']=$this->Report_model->view_employee();
        if(!empty($this->input->post()))
        {
           $data['reports']=$this->Report_model->view_reports(); 
        }
		template('report/report',$data);
	}
