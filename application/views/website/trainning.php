<?php
   $page='tranning';require_once('inc/top.php');
?>
<!-- //header -->
...
<section class="contact py-sm-5 py-4">
	<div class="container py-md-3">
		<h2 class="heading text-capitalize text-center mb-lg-5 mb-sm-4 mb-3"> Tranning</h2>
		<div class="contact-form" style="max-width: 80%; margin: 0px auto; border:2px solid gray; padding: 50px;">
			<form action="#" method="post">
				<div class="row main-w3layouts-sectns">
					<div class="col-lg-12 col-md-6 w3-btm-spc form-text1">
						<label><span class="fa fa-user"></span> Your Name:</label>
						<input type="text" name="Name" placeholder="John Watson" required="">
					</div>
					<div class="col-lg-12 col-md-6 w3-btm-spc form-text2">
					...
					<div class="col-lg-12 col-md-6 w3-btm-spc form-text2">
						...
						<input type="text" name="subject" placeholder="City" required="">
					</div>
				</div>
